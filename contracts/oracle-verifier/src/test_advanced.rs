...
fn three_oracle_median_is_middle_value() {
    ...
    c.submit_data(&o1, &wt(), &kk(), &10_000_000i128, &90u32, &1748736000u64);
    c.submit_data(&o2, &wt(), &kk(), &30_000_000i128, &90u32, &1748736000u64);
    c.submit_data(&o3, &wt(), &kk(), &20_000_000i128, &90u32, &1748736000u64);
...
fn deactivated_oracle_cannot_submit() {
    ...
    c.submit_data(&oracle, &wt(), &kk(), &10_000_000i128, &90u32, &1748736000u64);
}
...
fn overwrite_submission_updates_value() {
    ...
    c.submit_data(&oracle, &wt(), &kk(), &10_000_000i128, &90u32, &1748736000u64);
    c.submit_data(&oracle, &wt(), &kk(), &25_000_000i128, &95u32, &1748736000u64);
...
fn even_count_median_is_average_of_middle_two() {
    ...
    c.submit_data(&o1, &wt(), &kk(), &10_000_000i128, &90u32, &1748736000u64);
    c.submit_data(&o2, &wt(), &kk(), &30_000_000i128, &80u32, &1748736000u64);
...
fn test_weighted_median() {
    ...
    c.submit_data(&o1, &wt(), &kk(), &100_000_000i128, &90u32, &1748736000u64);
    c.submit_data(&o2, &wt(), &kk(), &50_000_000i128, &90u32, &1748736000u64);
...
fn verify_trigger_greater_than() {
    ...
    let oracle = Address::generate(&env);
    c.add_oracle(&admin, &oracle, &wt(), &90u32);
    c.submit_data(&oracle, &wt(), &kk(), &80_000_000i128, &90u32, &1748736000u64);
